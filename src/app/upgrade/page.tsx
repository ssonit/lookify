            ...
            <div className="flex flex-col min-h-screen bg-background font-body">
                ...
                <main className="flex-1 w-full container mx-auto px-4 py-8 md:py-16">
                    ...
                    <div className="text-center py-12">
                        <p className="text-red-500">Có lỗi xảy ra khi tải dữ liệu bài viết. Vui lòng thử lại sau.</p>
                    </div>
                </main>
                <Footer />
            </div>
                ...
                {isLoading ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {Array.from({ length: 8 }).map((_, index) => (
                            <Card key={index} className="bg-card rounded-2xl overflow-hidden group h-full flex flex-col">
                                    ...
                                    <CardContent className="p-4 flex flex-col flex-grow">
                                        ...
                                        <div className="flex justify-between items-center mt-auto pt-2 border-t">
                                            ...
                                            <Button variant="secondary" size="sm" className="rounded-lg">
                                                {article.platform === 'youtube' && <Youtube className="mr-1.5" />}
                                                {article.platform === 'tiktok' && <TiktokIcon className="mr-1.5 h-4 w-4" />}
                                                {article.cta}
                                            </Button>
                                        </div>
                                    </CardContent>
